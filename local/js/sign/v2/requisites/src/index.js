import { Dom, Tag, Loc, ajax, Runtime, Reflection, Text } from 'main.core';
...
export class Requisites extends EventEmitter
{
	...
	#crmEditorHtml: string;
	#crmEditor: ?BX.Crm.EntityEditor;
	#api: API;
	...
	{
		const responsibleTitle = Loc.getMessage('SIGN_PARTY_RESPONSIBLE_TITLE');
		const hintMessage = Loc.getMessage('SIGN_PARTY_RESPONSIBLE_HINT');
