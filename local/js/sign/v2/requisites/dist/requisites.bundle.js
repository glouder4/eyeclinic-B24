...
(function (exports,main_core,main_core_events,main_loader,sign_v2_api) {
	...
	var _crmEditorHtml = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("crmEditorHtml");
	var _crmEditor = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("crmEditor");
	...
	class Requisites extends main_core_events.EventEmitter {
	  constructor() {
	    ...
	    Object.defineProperty(this, _crmEditorHtml, {
	      writable: true,
	      value: void 0
	    });
	    Object.defineProperty(this, _crmEditor, {
	      writable: true,
	      value: void 0
	    });
		...
		`));
	    babelHelpers.classPrivateFieldLooseBase(this, _crmEditorHtml)[_crmEditorHtml] = '';
	    babelHelpers.classPrivateFieldLooseBase(this, _crmEditor)[_crmEditor] = null;
	  ...
	  getLayout() {
	    const responsibleTitle = main_core.Loc.getMessage('SIGN_PARTY_RESPONSIBLE_TITLE');
	    const hintMessage = main_core.Loc.getMessage('SIGN_PARTY_RESPONSIBLE_HINT');
	    const initiatorName = this.documentData.initiator;
	    const preparingNode = main_core.Tag.render(_t2 || (_t2 = _`
		...
		`), responsibleTitle, hintMessage, main_core.Text.encode(initiatorName), ({
	      target
	    }) => {
	      this.emit('changeInitiator', {
	        initiator: target.value
	      });
	    }, babelHelpers.classPrivateFieldLooseBase(this, _requisitesNode)[_requisitesNode]);
