...
class CCalendarSect
{
	...
	private static function GetFields()
	{
		...
		if (empty(self::$Fields))
		{
			self::$Fields = [
				...
				"FIO" => ["FIELD_NAME" => "CS.FIO", "FIELD_TYPE" => "string"],
				"PHONE" => ["FIELD_NAME" => "CS.PHONE", "FIELD_TYPE" => "string"],
	...
	public static function Edit($params)
	{
		...
		if (!empty($sectionFields['FIO']))
		{
			$sectionFields['FIO'] = Emoji::encode($sectionFields['FIO']);
		}
		if (!empty($sectionFields['PHONE']))
		{
			$sectionFields['PHONE'] = Emoji::encode($sectionFields['PHONE']);
		}
